...
const SKILLS = [
  { name: "HTML", icon: <FaHtml5 className="w-16 h-16" /> },
  { name: "CSS", icon: <FaCss3Alt className="w-16 h-16" /> },
  { name: "JavaScript", icon: <FaJsSquare className="w-16 h-16" /> },
  ...
  { name: "Tailwind", icon: <SiTailwindcss className="w-16 h-16" /> },
  ...
  { name: "Vercel", icon: <SiVercel className="w-16 h-16" /> },
            ...
            >
              <Card className="glass-card hover-glow group">
                <CardContent className="flex flex-col items-center justify-center p-6">
                  <motion.div className="w-16 h-16 md:w-20 md:h-20 relative mb-2" whileHover={{ scale: 1.1, rotate: 5 }}>
                    {skill.icon}
                  </motion.div>
